$(document).ready(function() {
    // Declaring Initial Array of Topics which is a list of some vehicles
    var topics = ['car', 'aircraft', 'ship', 'helicopter','camry'];
    ...
    // Click on car button to display Gifs and other info from API
    ...
    // Double-click on any car button to remove it from the array. Tried this for the first time.
